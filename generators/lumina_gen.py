...
SCHEMAS = {
    ...
    "oxblood": {
        ...
        "function_call": "orange", "property": "green",
        "preprocessor": "yellow", "escape": "red",
        "modeline_modified": "orange",
        "rainbow":   ["yellow", "orange", "red", "green", "magenta", "blue"],
        "outline":   ["yellow", "orange", "red", "green"],
        "orderless": ["yellow", "orange", "red"],
        "magit_branch_local": "orange", "magit_branch_remote": "yellow",
        "org_todo": "red", "org_done": "green",
    },
    "ember": {
        "lead": "orange",
        "modeline_bg": "bg-alt", "vertico_bg": "base3",
        "function_call": "blue", "property": "yellow",
        "preprocessor": "orange", "escape": "red",
        "modeline_modified": "red",
        "rainbow":   ["orange", "red", "yellow", "blue", "green", "violet"],
        "outline":   ["orange", "red", "yellow", "blue"],
        "orderless": ["orange", "red", "yellow"],
        "magit_branch_local": "blue", "magit_branch_remote": "orange",
        "org_todo": "red", "org_done": "green",
    },
    "tide": {
        "lead": "green",
        ...
        "preprocessor": "green", "escape": "magenta",
        "modeline_modified": "orange",
        "rainbow":   ["green", "blue", "violet", "orange", "cyan", "red"],
        "outline":   ["green", "blue", "violet", "orange"],
        "orderless": ["green", "blue", "violet"],
        "magit_branch_local": "blue", "magit_branch_remote": "blue",
        "org_todo": "red", "org_done": "green",
    },
    "indigo": {
        "lead": "blue",
        "modeline_bg": "bg-alt", "vertico_bg": "base3",
        "function_call": "violet", "property": "green",
        "preprocessor": "blue", "escape": "orange",
        "modeline_modified": "orange",
        "rainbow":   ["blue", "violet", "green", "orange", "magenta", "yellow"],
        "outline":   ["blue", "violet", "green", "orange"],
        "orderless": ["blue", "violet", "green"],
        "magit_branch_local": "violet", "magit_branch_remote": "blue",
        "org_todo": "red", "org_done": "green",
    },
    "canopy": {
        "lead": "yellow",
        "modeline_bg": "bg-alt", "vertico_bg": "base3",
        "function_call": "green", "property": "teal",
        "preprocessor": "yellow", "escape": "orange",
        "modeline_modified": "orange",
        "rainbow":   ["yellow", "green", "teal", "orange", "red", "blue"],
        "outline":   ["yellow", "green", "teal", "orange"],
        "orderless": ["yellow", "green", "teal"],
        "magit_branch_local": "green", "magit_branch_remote": "teal",
        "org_todo": "red", "org_done": "green",
    },
    "slate": {
        "lead": "blue",
    ...
    "aurora": {
        ...
        "modeline_bg": "bg-alt", "vertico_bg": "base3",
        "function_call": "blue", "property": "cyan",
        "preprocessor": "green", "escape": "violet",
        "modeline_modified": "orange",
        "rainbow":   ["green", "violet", "blue", "orange", "cyan", "magenta"],
        "outline":   ["green", "violet", "blue", "orange"],
        "orderless": ["green", "violet", "blue"],
        "magit_branch_local": "blue", "magit_branch_remote": "cyan",
        "org_todo": "orange", "org_done": "green",
    },
    "solitude": {
        "lead": "teal",
        "modeline_bg": "bg-alt", "vertico_bg": "base2",
        "function_call": "teal", "property": "dark-cyan",
        "preprocessor": "blue", "escape": "orange",
        "modeline_modified": "orange",
        "rainbow":   ["teal", "dark-cyan", "green", "orange", "blue", "violet"],
        "outline":   ["teal", "dark-cyan", "green", "orange"],
        "orderless": ["teal", "dark-cyan", "green"],
        "magit_branch_local": "teal", "magit_branch_remote": "dark-cyan",
        "org_todo": "orange", "org_done": "teal",
    },
    "monastery": {
        "lead": "yellow",
        "modeline_bg": "bg-alt", "vertico_bg": "base2",
        "function_call": "orange", "property": "red",
        "preprocessor": "yellow", "escape": "red",
        "modeline_modified": "yellow",
        "rainbow":   ["yellow", "orange", "red", "green", "violet", "blue"],
        "outline":   ["yellow", "orange", "red", "green"],
        "orderless": ["yellow", "orange", "red"],
        "magit_branch_local": "orange", "magit_branch_remote": "yellow",
        "org_todo": "red", "org_done": "teal",
    },
    "jade": {
        "lead": "green",
        "modeline_bg": "bg-alt", "vertico_bg": "base2",
        "function_call": "dark-cyan", "property": "dark-cyan",
        "preprocessor": "green", "escape": "red",
        "modeline_modified": "orange",
        "rainbow":   ["green", "dark-cyan", "cyan", "red", "blue", "violet"],
        "outline":   ["green", "dark-cyan", "cyan", "red"],
        "orderless": ["green", "dark-cyan", "cyan"],
        "magit_branch_local": "dark-cyan", "magit_branch_remote": "green",
        "org_todo": "red", "org_done": "green",
    },
    "cherenkov": {
        "lead": "cyan",
        "modeline_bg": "bg-alt", "vertico_bg": "base2",
        "function_call": "violet", "property": "blue",
        "preprocessor": "cyan", "escape": "green",
        "modeline_modified": "yellow",
        "rainbow":   ["cyan", "violet", "blue", "green", "magenta", "orange"],
        "outline":   ["cyan", "violet", "blue", "green"],
        "orderless": ["cyan", "violet", "blue"],
        "magit_branch_local": "violet", "magit_branch_remote": "cyan",
        "org_todo": "red", "org_done": "green",
    },
    "vesper": {
        "lead": "yellow",
        ...
        "preprocessor": "yellow", "escape": "red",
        "modeline_modified": "orange",
        "rainbow":   ["yellow", "violet", "blue", "magenta", "green", "orange"],
        "outline":   ["yellow", "violet", "blue", "magenta"],
        "orderless": ["yellow", "violet", "blue"],
        "magit_branch_local": "violet", "magit_branch_remote": "blue",
        "org_todo": "red", "org_done": "green",
    },
    "eclipse": {
        "lead": "yellow",
        "modeline_bg": "bg-alt", "vertico_bg": "base2",
        "function_call": "fg", "property": "blue",
        "preprocessor": "yellow", "escape": "red",
        "modeline_modified": "yellow",
        "rainbow":   ["yellow", "blue", "green", "red", "teal", "violet"],
        "outline":   ["yellow", "blue", "green", "red"],
        "orderless": ["yellow", "blue", "green"],
        "magit_branch_local": "yellow", "magit_branch_remote": "blue",
        "org_todo": "red", "org_done": "teal",
    },
    "petrichor": {
        "lead": "red",
        "modeline_bg": "bg-alt", "vertico_bg": "base2",
        "function_call": "green", "property": "fg-alt",
        "preprocessor": "red", "escape": "orange",
        "modeline_modified": "orange",
        "rainbow":   ["red", "green", "orange", "blue", "teal", "magenta"],
        "outline":   ["red", "green", "orange", "blue"],
        "orderless": ["red", "green", "orange"],
        "magit_branch_local": "green", "magit_branch_remote": "blue",
        "org_todo": "red", "org_done": "teal",
    },
    "atelier": {
        "lead": "yellow",
        ...
        "preprocessor": "yellow", "escape": "red",
        "modeline_modified": "orange",
        "rainbow":   ["yellow", "blue", "green", "red", "orange", "violet"],
        "outline":   ["yellow", "blue", "green", "red"],
        "orderless": ["yellow", "blue", "green"],
        "magit_branch_local": "blue", "magit_branch_remote": "yellow",
        "org_todo": "red", "org_done": "teal",
    },
    "cinnabar": {
        "lead": "red",
        "modeline_bg": "bg-alt", "vertico_bg": "base2",
        "function_call": "yellow", "property": "green",
        "preprocessor": "red", "escape": "green",
        "modeline_modified": "yellow",
        "rainbow":   ["red", "yellow", "green", "blue", "orange", "magenta"],
        "outline":   ["red", "yellow", "green", "blue"],
        "orderless": ["red", "yellow", "green"],
    ...
    "prisma": {
        ...
        "modeline_modified": "orange",
        "rainbow":   ["violet", "blue", "green", "orange", "red", "magenta"],
        "outline":   ["violet", "blue", "green", "orange"],
        "orderless": ["violet", "blue", "green"],
        "magit_branch_local": "blue", "magit_branch_remote": "violet",
        "org_todo": "red", "org_done": "green",
    },
    "tyrian": {
        "lead": "magenta",
        "modeline_bg": "bg-alt", "vertico_bg": "base2",
        "function_call": "yellow", "property": "blue",
        "preprocessor": "magenta", "escape": "violet",
        "modeline_modified": "yellow",
        "rainbow":   ["magenta", "yellow", "blue", "violet", "green", "orange"],
        "outline":   ["magenta", "yellow", "blue", "violet"],
        "orderless": ["magenta", "yellow", "blue"],
        "magit_branch_local": "yellow", "magit_branch_remote": "magenta",
        "org_todo": "red", "org_done": "green",
    },
    "lapis": {
        "lead": "blue",
        "modeline_bg": "bg-alt", "vertico_bg": "base2",
        "function_call": "violet", "property": "cyan",
        "preprocessor": "blue", "escape": "yellow",
        "modeline_modified": "yellow",
        "rainbow":   ["blue", "violet", "cyan", "yellow", "orange", "magenta"],
        "outline":   ["blue", "violet", "cyan", "yellow"],
        "orderless": ["blue", "violet", "cyan"],
        "magit_branch_local": "violet", "magit_branch_remote": "cyan",
        "org_todo": "red", "org_done": "green",
    },
    "cherenkov": {
        ...
        "preprocessor": "violet", "escape": "orange",
        "modeline_modified": "red",
        "rainbow":   ["cyan", "green", "blue", "violet", "magenta", "yellow"],
        "outline":   ["cyan", "green", "blue", "violet"],
        "orderless": ["cyan", "green", "violet"],
        "magit_branch_local": "blue", "magit_branch_remote": "green",
        "org_todo": "orange", "org_done": "green",
    },
    "nocturne": {
...
def build_vscode(spec: dict):
    ...
    pkg = {
        ...
        "description":
            ...
            "field. Twenty flavors × dark/light.",
        "version": "1.0.0",
        "publisher": "RazikSF",
        "license": "MIT",
